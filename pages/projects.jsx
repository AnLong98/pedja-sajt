                ...
                <div className="flex flex-wrap -mx-4">
                    {
                        projectsList.map(el =>
                            ...
                            <div key={el.name} className="m-5 max-w-sm bg-white rounded-lg border-[#66fcf1] shadow-md border-solid border-6">
                                <div className='h-[208px] container px-auto'>
                                    <Image className="rounded-t-lg mx-auto relative" src={el.image} alt="" priority />
                                </div>
                                <div className="p-5">
